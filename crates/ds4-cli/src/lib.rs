...
VARIANT is flash|pro|solar-open2|motif3|exaone-moe|dots3-note|qwen4exp|glm5-next|k2-horizon
...
mod tests {
    ...
    #[test]
    fn help_names_k2_horizon_variant_and_tokenizer_alias() {
        let help = help_text("ds4-rs");
        assert!(help.contains("k2-horizon"));
    }
