...
| MiMo-V2.6-Flash-RL | `mimo2` | Four-shard mixed GGUF. Serial CUDA text, qualified embedded MTP, and an external five-layer DFlash draft. Image, audio, and video are qualified. Qualified context 524288. Prefill chunk 4096. max_seqs 2 is omitted because the graph is serial. 1M is not qualified. |
