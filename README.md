...
| MiMo-V2.6-Flash-RL | `mimo2` | Four-shard mixed GGUF. Serial CUDA text and three embedded MTP blocks. Image, audio, and video projector execution is qualified. Qualified context 262144. DFlash, 512k, and 1M are not qualified. |
