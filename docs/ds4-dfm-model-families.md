...
| MiMo-V2.6-Flash-RL | `general.architecture=mimo2` | 48 trunk layers, 9 full-attention and 39 SWA-128, 256 experts top-8, three embedded dense MTP blocks. Image, audio, and video projector execution is qualified. Qualified context 262144. DFlash, 512k, and 1M are not qualified. |
