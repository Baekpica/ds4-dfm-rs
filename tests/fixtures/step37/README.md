...
2048, valid 1–4096, capped by context). `512` restores the pre-campaign
default; `1024` is the intermediate campaign stage. 64 is the locked
structural gate width.
